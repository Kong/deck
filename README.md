...
```shell
$ curl -sL https://github.com/kong/deck/releases/download/v1.59.1/deck_1.59.1_linux_amd64.tar.gz -o deck.tar.gz
...
```shell
$ curl -sL https://github.com/kong/deck/releases/download/v1.59.1/deck_1.59.1_windows_amd64.tar.gz -o deck.tar.gz
