...
```shell
$ curl -sL https://github.com/kong/deck/releases/download/v1.57.3/deck_1.57.3_linux_amd64.tar.gz -o deck.tar.gz
...
```shell
$ curl -sL https://github.com/kong/deck/releases/download/v1.57.3/deck_1.57.3_windows_amd64.tar.gz -o deck.tar.gz
