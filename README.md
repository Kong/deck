...
```shell
$ curl -sL https://github.com/kong/deck/releases/download/v1.39.7/deck_1.39.7_linux_amd64.tar.gz -o deck.tar.gz
...
```shell
$ curl -sL https://github.com/kong/deck/releases/download/v1.39.7/deck_1.39.7_windows_amd64.tar.gz -o deck.tar.gz
