...
func (in *API) DeepCopyInto(out *API) {
	*out = *in
	...
	if in.HTTPIfTerminated != nil {
		in, out := &in.HTTPIfTerminated, &out.HTTPIfTerminated
		*out = new(bool)
		**out = **in
	}
	if in.HTTPSOnly != nil {
	...
	if in.UpstreamURL != nil {
		in, out := &in.UpstreamURL, &out.UpstreamURL
		*out = new(string)
		**out = **in
	}
	return
