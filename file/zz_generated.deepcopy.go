...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KICContent) DeepCopyInto(out *KICContent) {
	*out = *in
	if in.KongIngresses != nil {
		in, out := &in.KongIngresses, &out.KongIngresses
		*out = make([]v1.KongIngress, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.KongPlugins != nil {
		...
		*out = make([]v1.KongPlugin, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.KongClusterPlugins != nil {
		in, out := &in.KongClusterPlugins, &out.KongClusterPlugins
		*out = make([]v1.KongClusterPlugin, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Ingresses != nil {
		...
		*out = make([]networkingv1.Ingress, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.KongConsumers != nil {
		in, out := &in.KongConsumers, &out.KongConsumers
		*out = make([]v1.KongConsumer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.KongConsumerGroups != nil {
		in, out := &in.KongConsumerGroups, &out.KongConsumerGroups
		*out = make([]v1beta1.KongConsumerGroup, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KICContent.
func (in *KICContent) DeepCopy() *KICContent {
	if in == nil {
		return nil
	}
	out := new(KICContent)
