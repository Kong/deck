...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FDeveloper) DeepCopyInto(out *FDeveloper) {
	*out = *in
	in.Developer.DeepCopyInto(&out.Developer)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FDeveloper.
func (in *FDeveloper) DeepCopy() *FDeveloper {
	if in == nil {
		return nil
	}
	out := new(FDeveloper)
