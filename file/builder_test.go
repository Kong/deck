...
var (
	basicAuthPluginSchema = map[string]interface{}{
		"fields": []interface{}{
	...
	requestTransformerPluginSchema = map[string]interface{}{
		"fields": []interface{}{
			map[string]interface{}{
				"config": map[string]interface{}{
					"fields": []interface{}{
...
func TestFillPluginDefaults(T *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			plugin: &kong.Plugin{
				...
				Protocols: []*string{kong.String("grpc"), kong.String("grpcs")},
			},
			schema: basicAuthPluginSchema,
			expected: &kong.Plugin{
				Name: kong.String("basic-auth"),
		...
		{
			name: "do not overwrite existing bool",
			plugin: &kong.Plugin{
				Name:    kong.String("basic-auth"),
		...
		},
		{
			...
			schema: requestTransformerPluginSchema,
			expected: &kong.Plugin{
				Name: kong.String("request-transformer"),
				Config: kong.Configuration{
					"http_method": nil,
		...
		{
			name: "nested do not overwrite existing fields",
			plugin: &kong.Plugin{
				Name: kong.String("request-transformer"),
				Config: kong.Configuration{
					"add": map[string]interface{}{
						"body":        []interface{}{},
						"headers":     []interface{}{"add-this-header"},
						"querystring": []interface{}{},
					},
				},
			},
	...
	for _, tc := range tests {
		T.Run(tc.name, func(t *testing.T) {
			got, err := kong.FillPluginsDefaults(tc.plugin, tc.schema)
			if err != nil {
				t.Errorf(err.Error())
			}
