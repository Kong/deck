...
func (in *Document) DeepCopyInto(out *Document) {
	*out = *in
	...
	if in.Parent != nil {
		out.Parent = in.Parent.DeepCopyParentInfoer()
	}
	return
}
...
// DeepCopyParentInfoer is an autogenerated deepcopy function, copying the receiver, creating a new ParentInfoer.
func (in *ServicePackage) DeepCopyParentInfoer() ParentInfoer {
...
// DeepCopyParentInfoer is an autogenerated deepcopy function, copying the receiver, creating a new ParentInfoer.
func (in *ServiceVersion) DeepCopyParentInfoer() ParentInfoer {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
